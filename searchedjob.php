                ...
                <div class="css-1dbjc4n r-1awozwy r-14lw9ot r-qklmqi r-1wdxeg r-18u37iz r-1mwlp6a r-ymttw5 r-184en5c">
                    ...
                    <div class="css-1dbjc4n r-13awgt0">
                        <h1 style="margin: 0px; line-height: 0;">
                            <div dir="auto" class="css-76zvg2 r-1t176gz r-adyw6z r-1kfrs79 r-vrz42v r-1ttztb7 r-3twk1y">Job Search</div>
                        </h1>
                    </div>
                </div>
                                ...
                                <div class="css-1dbjc4n r-edyy15">
                                    ...
                                    <div class="css-1dbjc4n">
                                        <div class="css-1dbjc4n r-1awozwy r-18u37iz r-1777fci r-kzbkwu r-1ygmrgt">
                                            ...
                                            $sql1 = "SELECT * FROM category WHERE id='$ctid'";
                                            $result1 = mysqli_query($con, $sql1);
                                            $row1 = mysqli_fetch_assoc($result1);
                                            echo $row1['cate_name'];
                                             ?> in <?php 
                                             $sql1 = "SELECT * FROM city WHERE id='$cid'";
                                            $result1 = mysqli_query($con, $sql1);
                                            $row1 = mysqli_fetch_assoc($result1);
                                            echo $row1['city_name'];
                                             ?> </div>
...
<?php 
$sql = "SELECT * FROM jobs WHERE cid='$cid' and cate_id='$ctid'";
