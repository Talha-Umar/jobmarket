                ...
                <div class="css-1dbjc4n r-1awozwy r-14lw9ot r-qklmqi r-1wdxeg r-18u37iz r-1mwlp6a r-ymttw5 r-184en5c">
                    ...
                    <div class="css-1dbjc4n r-13awgt0">
                        <h1 style="margin: 0px; line-height: 0;">
                            <div dir="auto" class="css-76zvg2 r-1t176gz r-adyw6z r-1kfrs79 r-vrz42v r-1ttztb7 r-3twk1y" style="text-align: center !important;">Posted Jobs</div>
                        </h1>
                    </div>
                </div>
                                ...
                                <div class="css-1dbjc4n r-edyy15">
                                    ...
                                    <div class="css-1dbjc4n">
                                        <div class="css-1dbjc4n r-1awozwy r-18u37iz r-1777fci r-kzbkwu r-1ygmrgt">
                                            <div dir="auto" class="css-76zvg2 r-1ok0lxs r-ubezar r-1it3c9n r-rjixqe r-1ttztb7 r-3twk1y">Your Posted Jobs are Here </div>
                                        </div>
                                    </div>
 <?php
            include '../db.php';
...
<div class="ant-col ant-col-24"><div class="ant-row job-details-container" style="row-gap: 0px;">
    ...
    <div class="ant-col ant-col-12 job-title"><button type="button" class="ant-btn ant-btn-link title-container"><div class="ant-typography ant-typography-ellipsis ant-typography-single-line ant-typography-ellipsis-single-line  font-bold text-capitalize"><?php echo $row['job_title']; ?></div>
    </button><br>
    <button type="button" class="ant-btn ant-btn-link">
    <span class="ant-typography  color-blue-grey-5 p-top-8"><?php
     $city=$row['cid'];
...
echo $row1['city_name'];
    ...
    <div class="ant-col ant-col-12 app-stats-container">

    <div class="ant-row ant-row-space-between p-top-8" style="row-gap: 0px; text-align: center;">

        <div style="width: 110px;
    height: 70px;
    -webkit-box-shadow: 0 2px 0 0 rgb(91 120 124 / 16%);
    box-shadow: 0 2px 0 0 rgb(91 120 124 / 16%);
    border-radius: 4px;
    ...
    flex-direction: column;
    padding: 1.5rem;
    cursor: pointer;"><span class="ant-typography ">Applied</span><span class="ant-typography text-extra-base" style="font-size: 18pt">
        <?php
    $jobid=$row['id'];
    $sql3 = "SELECT count(aname) as TA FROM applicant where job_id='$jobid'";
...
echo $row3['TA'];
    ...
    padding: .5rem;
    cursor: pointer;
    "><span class="ant-typography ">Database</span><span class="ant-typography text-extra-base"><a href="#jobid?<?php echo $row['id']; ?>" class="ant-typography" style="color: blue;">Find Candidates</a></span></div>
    ...
    <div class="ant-row job-card-footer" style="row-gap: 0px;">
        <div class="ant-col ant-col-3 display-flex margin-right-2rem">
       <a href="editjob.php?jobid=<?php echo $row['id']; ?>">
            <button type="button" class="ant-btn link-btn font-bold">
        ...
        <img alt="pencil Icon" src="https://employer.waahjobs.com//images/jobs-tab/pencil-icon-24x24.svg?w=24&amp;q=80" decoding="async" class="p-right-2"  style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"></div>
        <span>Edit</span>
    </button>
       </a>
    </div>

    <div class="ant-col ant-col-9 display-flex margin-right-2rem">
        <button type="button" class="ant-btn link-btn font-bold">
        <div style="display: inline-block; max-width: 100%; overflow: hidden; position: relative; box-sizing: border-box; margin: 0px;">
        <div style="box-sizing: border-box; display: block; max-width: 100%;"><img alt="" aria-hidden="true" role="presentation" src="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjQiIGhlaWdodD0iMjQiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyIgdmVyc2lvbj0iMS4xIi8+" style="max-width: 100%; display: block; margin: 0px; border: none; padding: 0px;"></div>
        <img alt="Share Icon" src="https://employer.waahjobs.com//images/jobs-tab/share-icon-24x24.svg?w=24&amp;q=80" decoding="async" class="p-right-2"  style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"></div>
        <span>Share</span>
    </button>
    </div>
        ...
        <div class="ant-col ant-col-12 app-stats-container display-flex flex-align-items-center">
            <div class="ant-typography ant-typography-ellipsis ant-typography-single-line ant-typography-ellipsis-single-line color-blue-grey-5 ">Posted by <?php
              
             $emp=$row['emp_id'];
     $sql2 = "SELECT * FROM employer where id='$emp'";
